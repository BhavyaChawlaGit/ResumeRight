...
- Be truthful and objective to the experience listed in the Resume
...
Write the projects section according to the Projects schema. Include all projects, but only the ones present in the Resume. On the response, include only the JSON.
"""
...
Write the skills section according to the Skills schema. Include only up to the top 4 skill names that are present in the Resume and related with the education and work experience. On the response, include only the JSON.
"""
...
def generate_json_resume(cv_text, api_key, model="gpt-3.5-turbo"):
    """Generate a JSON resume from a Resume text"""
    sections = []
